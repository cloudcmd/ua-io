...
Особливості обмеженого режиму (режиму обмеження)
---------------
- без прив'язки до клавіш
- без локального кешування
- повне завантаження усієї веб сторінки (зі стилями, js-скриптами, html-сторінка тощо).
...
за допомогою декількох команд в папці Клауд Командера:
...
Додаткові модулі
---------------
**Серверна частина Клауд Командера** не використовує додаткові модулі для основного функціоналу.
...
Щоб встановити додаткові модулі, напишіть знаходячись в папці **Клауд Командера**:

    npm i

Розширення
---------------
**Клауд Командер** створено з можливістю легкого розширення основного функціоналу.
Щоб розширити функціонал Клауд Командера, використовуйте такі модулі:
- [Ace]                     [AceURL]
